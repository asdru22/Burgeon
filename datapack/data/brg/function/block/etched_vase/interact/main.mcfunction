...
execute if entity @s[tag=brg.etched_vase.has_soil, tag=!brg.etched_vase.has_seed] if data storage brg:temp root.item.components."minecraft:custom_data".brg.seed run return run function brg:block/etched_vase/interact/seed/place
