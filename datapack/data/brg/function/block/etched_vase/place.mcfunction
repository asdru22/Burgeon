...
execute align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:stone",count:1,components:{"item_model":"brg:block/etched_vase","minecraft:custom_model_data":{"strings":["ground"]}}},Tags:["brg.block","brg.tick","brg.etched_vase","brg.etched_vase.initiate","smithed.block","smithed.entity","brg.item_display"],view_range:4.0f,teleport_duration:0,interpolation_duration:0,Passengers:[{id:"minecraft:interaction",width: 0.5, height:0.1, Tags:["brg.interaction","brg.interaction.etched_vase"],response:true}]}
