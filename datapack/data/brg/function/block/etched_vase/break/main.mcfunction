...
execute if entity @s[tag=brg.etched_vase.has_soil] run function brg:block/etched_vase/break/drop_soil with entity @s item.components."minecraft:custom_data".brg.soil
