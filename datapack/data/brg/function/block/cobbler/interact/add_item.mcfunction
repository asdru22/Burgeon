...
execute as @p[advancements={brg:technical/player_interacted_with_entity/interaction={interact=true}}] positioned -29999966 0 -29999966 run function brg:block/cobbler/interact/insert_item
