...
execute as @e[type=minecraft:item_display,tag=brg.prevents_hoppers,tag=brg.block,distance=..5] at @s positioned ~ ~-1 ~ run function brg:block/hopper_updating/fill
