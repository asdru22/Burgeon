...
execute if entity @s[scores={brg.dummy2=5..}] run function brg:item/scarlet_fang/spore/track_entity with entity @s item.components."minecraft:custom_data".brg.macro_input
