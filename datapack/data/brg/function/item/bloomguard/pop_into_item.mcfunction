...
execute if predicate {condition:"random_chance",chance:0.1} unless data entity @s item.components."minecraft:custom_data".brg{gamemode:1} run function brg:technical/macros/loot/spawn with storage brg:temp root.item
