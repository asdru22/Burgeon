...
execute positioned ^ ^ ^0.05 if predicate brg:location_check/bloomguard_fire_block if entity @s[tag=!brg.bloomguard.on_fire] run function brg:item/bloomguard/catch_fire


# If bloomguard *doesn't* hit a block, it moves
execute if block ^ ^ ^0.05 #brg:bloomguard/ignore unless predicate brg:location_check/in_water run tp @s ^ ^ ^0.05
execute if block ^ ^ ^0.05 #brg:bloomguard/ignore if predicate brg:location_check/in_water run tp @s ^ ^ ^0.025
...
execute if entity @s[scores={brg.dummy2=2..}] at @s unless block ^ ^ ^0.05 #brg:bloomguard/ignore positioned ^ ^ ^-0.5 run function brg:item/bloomguard/pop_into_item
