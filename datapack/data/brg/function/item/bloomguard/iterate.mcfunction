...
execute if block ^ ^ ^0.1 #brg:bloomguard/ignore unless predicate brg:location_check/in_water run tp @s ^ ^ ^0.1
execute if block ^ ^ ^0.1 #brg:bloomguard/ignore if predicate brg:location_check/in_water run tp @s ^ ^ ^0.05
